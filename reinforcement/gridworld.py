...
if __name__ == '__main__':
    ...
    import valueIterationAgents, qlearningAgents,policyiteration
    a = None
    if opts.agent == 'value':
        a = valueIterationAgents.ValueIterationAgent(mdp, opts.discount, opts.iters)
    elif opts.agent == 'policy':
        a = policyiteration.PolicyIterationAgent(mdp, opts.discount, opts.iters)
    ...
    if opts.episodes > 0:
        ...
        print("No. of iterations : "+str(a.counter))
        print()
        print()
